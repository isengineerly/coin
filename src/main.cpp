...
//#1
int64 nChainStartTime = 1489074445;
...
const string strMessageMagic = "mosescoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in mosescoin
    bool fStrictPayToScriptHash = true; // Always active in mosescoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "mosescoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //#1
        const char* pszTimestamp = "mosescoin created by SMITH 2017/03/09";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        //#1
        assert(block.hashMerkleRoot == uint256("0xa896475fe26cad93b3d781d1d0c93a8f4fa0b86e5401da63370f229ae9c0a9ab"));
